...
public class SeventhActivity extends AppCompatActivity {
    ...
    public final static String EXTRA_MESSAGE6 = "sixth_extra_message";
    public final static String EXTRA_MESSAGE7 = "seventh_extra message";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final String message3 = intent.getStringExtra(SixthActivity.EXTRA_MESSAGE3);
        final String message4 = intent.getStringExtra(SixthActivity.EXTRA_MESSAGE4);
        final String message5 = intent.getStringExtra(SixthActivity.EXTRA_MESSAGE5);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(userResponse)) {
                    ...
                    intent.putExtra(EXTRA_MESSAGE7, userInput);
